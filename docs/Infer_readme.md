...
|类别|支持架构|模型|厂商|镜像（考虑不放,，优先填前面的）|
|---|---|---|---|---|
|**异构集群间混合调度**|vLLM|Qwen3 32B|天数\+NV||
|||Intern S1|昇腾||
|||LLaMA \& LLaMA\-2、Qwen、Chatglm2 \& Chatglm3|海光||
|||Qwen3\-0\.6B|燧原||
|||Qwen3|壁仞||
||LMDeploy|Qwen3 32B|沐曦\+平头哥||
||SGLang|GLM、Kimi、Qwen3 Dense、Qwen3 MoE、Qwen3\.5、Qwen2\.5 VL、Qwen3 VL、Deepseek V3\.2 \& R1、Diffusion 模型|摩尔||
|**异构国产芯片混推**<br>（PD分离）|LMDeploy|Qwen3 32B<br>|沐曦\+平头哥<br>|- crpi\-z3i6df2ze96lh4ld\.cn\-hangzhou\.personal\.cr\.aliyuncs\.com/deeplink\_infer/deeplink\_infer:maca\-lmdeploy|
|**国产芯片\+NV混推**|vLLM|Qwen3 32B|天数\+NV|- |
